...
/**
 * Raster waveform — generated by `npm run generate:montage-waveform` (keeps saved email HTML small vs. bar tables).
 * Intrinsic size must match `scripts/generate-montage-waveform-png.mjs` (two cycles, edge fade).
 */
const PILOT_INVITE_MONTAGE_WAVEFORM_IMG = "/images/pilot-invite-montage-waveform.png";
const PILOT_INVITE_MONTAGE_WAVEFORM_IMG_W_PX = 480;
const PILOT_INVITE_MONTAGE_WAVEFORM_IMG_H_PX = 42;
...
function emailMontageWatermarkWaveformImgHtml(): string {
  const src = escapeHtml(absImg(PILOT_INVITE_MONTAGE_WAVEFORM_IMG));
  const w = PILOT_INVITE_MONTAGE_WAVEFORM_IMG_W_PX;
  const h = PILOT_INVITE_MONTAGE_WAVEFORM_IMG_H_PX;
        ...
        <tr>
          <td style="padding:26px 20px 0 20px;">
            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid rgba(0,0,0,0.06);border-radius:12px;overflow:hidden;box-shadow:0 8px 40px -8px rgba(0,0,0,0.12);">
              <tr>
                <td style="background-color:${MONTAGE_CHROME_BG_HEX};border-bottom:1px solid rgba(0,0,0,0.05);padding:3px 10px;">
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
                    <tr>
                      <td style="vertical-align:middle;white-space:nowrap;padding-right:8px;">
                        <span style="display:inline-block;width:6px;height:6px;border-radius:50%;background-color:${BIZMIS_PRIMARY_DARK_HEX};margin-right:3px;vertical-align:middle;"></span>
                        <span style="display:inline-block;width:6px;height:6px;border-radius:50%;background-color:${BIZMIS_PRIMARY_HEX};margin-right:3px;vertical-align:middle;"></span>
                        <span style="display:inline-block;width:6px;height:6px;border-radius:50%;background-color:${BIZMIS_PRIMARY_LIGHT_HEX};vertical-align:middle;"></span>
                      </td>
                      <td style="vertical-align:middle;width:99%;padding:0;">
                        <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background-color:#ffffff;border-radius:9999px;">
                          <tr>
                            <td style="padding:0 8px;height:13px;vertical-align:middle;line-height:13px;">
                              <span style="${BODY}font-size:7px;color:${MONTAGE_CHROME_URL_HEX};line-height:13px;">${domain}</span>
                            </td>
                          </tr>
                        </table>
                      </td>
