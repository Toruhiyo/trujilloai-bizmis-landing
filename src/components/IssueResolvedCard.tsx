...
export default function IssueResolvedCard({
  ...
  return (
    <div
      className="flex w-max max-w-[min(94vw,38rem)] shrink-0 items-center gap-2.5 rounded-3xl border border-primary/25 bg-white px-3.5 py-2 shadow-md xs:gap-3 xs:px-4 xs:py-2.5 sm:max-w-[min(92vw,42rem)]"
      style={{
    ...
    >
      ...
      <div className="flex min-w-0 flex-col gap-0.5 text-left">
        <span
          className="whitespace-nowrap text-[12px] font-heading font-bold text-foreground leading-tight xs:text-[13px] sm:text-[14px]"
          style={{
        ...
        <span
          className="break-words text-[11px] text-primary font-semibold leading-tight xs:text-[12px] sm:text-[13px]"
          style={{
