  ...
  const features = [
    {
      ...
      description:
        "Personalized shopping experience with custom avatars that guide customers to the perfect products.",
      benefits: [
    ...
    },
    {
      ...
      description:
        "Instant human-like assistance that never sleeps, handling queries and complaints with warmth.",
      benefits: [
        "Instant responses",
    ...
    },
    {
      ...
      description:
        "Deep insights into customer behavior with session replays and tagged conversations.",
      benefits: [
        "Session recordings",
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground font-body max-w-3xl mx-auto">
            Just like having the best sales team in your physical store, but
            available 24/7 for your online customers.
          </p>
        </div>
