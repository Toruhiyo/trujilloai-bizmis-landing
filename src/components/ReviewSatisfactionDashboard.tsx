...
const ReviewSatisfactionDashboard: React.FC = () => {
  ...
  const getTypeIcon = (type: string) => {
    switch (type) {
      ...
      default:
        return <ThumbsUp className="w-6 h-6 text-orange-600" />;
    }
  };
  ...
  const getTypeColor = (type: string) => {
    switch (type) {
      case "satisfaction":
        return "border-orange-400/80 bg-orange-50/95";
      case "speed":
        return "border-amber-400/80 bg-amber-50/95";
      case "resolution":
        return "border-orange-500/80 bg-orange-100/95";
      case "empathy":
        return "border-amber-500/80 bg-amber-100/95";
      default:
        return "border-orange-300/80 bg-orange-50/95";
    }
  };
